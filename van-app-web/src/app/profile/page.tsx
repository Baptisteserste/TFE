        ...
        <div className="flex flex-col md:flex-row gap-12">
          ...
          <aside className="w-full md:w-64 flex-shrink-0 space-y-2">
            <div className="flex items-center gap-4 mb-8">
              ...
              <div>
                <h2 className="font-bold text-lg">Baptiste</h2>
            ...
            <nav className="space-y-1">
              ...
              <button className="w-full flex items-center gap-3 px-4 py-3 rounded-xl text-red-400 hover:bg-red-400/10 transition-colors mt-8 text-left">
              ...
              <div className="bg-slate-900 border border-slate-800 rounded-2xl p-6 shadow-xl">
                ...
                <div className="grid sm:grid-cols-2 gap-6">
                  <div>
                    ...
                    <div className="font-medium">Baptiste</div>
                  </div>
                  <div>
                    <label className="text-sm text-slate-500 mb-1 block">Adresse e-mail</label>
                    <div className="font-medium">baptiste@example.com</div>
                  </div>
                  <div>
                  ...
                  <div>
                    <label className="text-sm text-slate-500 mb-1 block">Date d'inscription</label>
                    <div className="font-medium">Octobre 2023</div>
                  </div>
                </div>
              </div>
